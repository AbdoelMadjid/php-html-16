...
<header id="header">
	...
	<span id="extr-page-header-space"> <span class="hidden-mobile hiddex-xs">Need an account?</span> <a href="<?php echo APP_URL; ?>/misc-register.php" class="btn btn-danger">Create account</a> </span>
					...
					<form action="<?php echo APP_URL; ?>" id="login-form" class="smart-form client-form">
						...
						<fieldset>
							...
							<section>
								...
								<div class="note">
									<a href="<?php echo APP_URL; ?>/misc-forgotpassword.php">Forgot password?</a>
								</div>
							</section>
