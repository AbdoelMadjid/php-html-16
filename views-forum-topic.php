			...
			<div class="col-sm-12">
				...
				<div class="well">
					...
					<table class="table table-striped table-forum">
						<thead>
							<tr>
								<th colspan="2"><a href="views-forum.php"> Projects </a> > Business Requirement Docs</th>
						...
						<tbody>
							...
							<tr class="warning">
								...
								<td>
									<h4><a href="views-forum-post.php">
										Welcome message
									</a>
										<small><a href="views-profile.php">John Doe</a> on <em>January 1, 2014</em></small>
									</h4>
								</td>
