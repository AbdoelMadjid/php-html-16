...
<!-- ==========================CONTENT STARTS HERE ========================== -->
		...
		<header id="header">
			...
			<span id="extr-page-header-space"> <span class="hidden-mobile hiddex-xs">Need an account?</span> <a href="<?php echo APP_URL; ?>/misc-register.php" class="btn btn-danger">Creat account</a> </span>
				...
				<div class="row">
					...
					<div class="col-xs-12 col-sm-12 col-md-5 col-lg-4">
						<div class="well no-padding">
							<form action="<?php echo APP_URL; ?>/misc-login.php" id="login-form" class="smart-form client-form">
								<header>
									Forgot Password
								</header>
								...
								<fieldset>
									...
									<section>
										...
										<div class="note">
											<a href="<?php echo APP_URL; ?>/misc-login.php">I remembered my password!</a>
										</div>
									</section>
