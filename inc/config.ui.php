...
$page_nav = array(
	...
	"smartint" => array(
		...
		"sub" => array(
			"layouts" => array(
				"title" => "App Layouts",
				"icon" => "fa-gear",
				"url" => APP_URL."/smartint-layouts.php"
			),
		    "skins" => array(
		        "title" => "Prebuilt Skins",
		        "icon" => "fa-picture-o",
		        "url" => APP_URL."/smartint-skins.php"
		    ),			
		    "applayout" => array(
		        "title" => "App Settings",
		        "icon" => "fa-cube",
		        "url" => APP_URL."/smartint-applayout.php"
		    ),
		    "difver" => array(
		        "title" => "Different Versions",
		        "icon" => "fa-cube",
		        "url" => APP_URL."/smartint-difver.php"
		    )
		)
	),
	"outlook" => array(
	...
	"graphs" => array(
		...
		"sub" => array(
			"flot" => array(
				"title" => "Flot Chart",
				"url" => APP_URL."/graph-flot.php"
			),
			"morris" => array(
				"title" => "Morris Charts",
				"url" => APP_URL."/graph-morris.php"
			),
			"sparklines" => array(
				"title" => "Sparklines",
				"url" => APP_URL."/graph-sparkline-charts.php"
			),
			"easypie" => array(
				"title" => "EasyPieCharts",
				"url" => APP_URL."/graph-easypie-charts.php"
			),
			"dygraphs" => array(
				"title" => "Dygraphs",
				"url" => APP_URL."/graph-dygraphs.php",
			),
			"chartjs" => array(
				"title" => "Chart.js",
				"url" => APP_URL."/graph-chartjs.php"
			),
			"highchart" => array(
				"title" => "HighchartTable",
				"url" => APP_URL."/graph-hchartable.php",
	...
	"forms" => array(
		...
		"sub" => array(
            ...
            "bootstrap_editors" => array(
				...
				"url" => APP_URL."/form-other-editors.php"
			),
            "dropzone" => array(
				"title" => "Dropzone",
    ...
    "ui_elements" => array(
        ...
        "sub" => array(
            "general" => array(
                "title" => "General Elements",
                "url" => APP_URL."/ui-general-elements.php"
            ),
            "buttons" => array(
                "title" => "Buttons",
                "url" => APP_URL."/ui-buttons.php"
            ),
            "icons" => array(
                "title" => "Icons",
                "sub" => array(
                    "fa" => array(
                        "title" => "Font Awesome",
                        "icon" => "fa-plane",
                        "url" => APP_URL."/ui-icon-fa.php"
                    ),
                    "glyph" => array(
                        "title" => "Glyph Icons",
                        "icon" => "fa-plane",
                        "url" => APP_URL."/ui-icon-glyph.php"
                    ),
                    "flags" => array(
                        "title" => "Flags",
                        "icon" => "fa-flag",
                        "url" => APP_URL."/ui-icon-flags.php"
                    )
                )
            ),
            "grid" => array(
                "title" => "Grid",
                "url" => APP_URL."/ui-grid.php"
            ),
            "tree_view" => array(
                "title" => "Tree View",
                "url" => APP_URL."/ui-treeview.php"
            ),
            "nestable_lists" => array(
                "title" => "Nestable Lists",
                "url" => APP_URL."/ui-nestable-list.php"
            ),
            "jquery_ui" => array(
                "title" => "jQuery UI",
                "url" => APP_URL."/ui-jqui.php"
            ),
            "typo" => array(
				"title" => "Typography",
				"url" => APP_URL."/ui-typography.php"
			),
			"nav6" => array(
	...
	"views" => array(
		...
		"sub" => array(
			"projects" => array(
				...
				"url" => APP_URL."/views-projects.php"
			),
			"blog" => array(
				"title" => "Blog",
				"icon" => "fa fa-paragraph",
				"url" => APP_URL."/views-blog.php"
			),
			"gallery" => array(
				"title" => "Gallery",
				"icon" => "fa fa-picture-o",
				"url" => APP_URL."/views-gallery.php"
			),
			"forum" => array(
				"title" => "Forum Layout",
				"icon" => "fa fa-comments",
				"sub" => array(
					"general" => array(
						"title" => "General View",
						"url" => APP_URL."/views-forum.php"
					),
					"topic" => array(
						"title" => "Topic View",
						"url" => APP_URL."/views-forum-topic.php"
					),
					"post" => array(
						"title" => "Post View",
						"url" => APP_URL."/views-forum-post.php"
					),
				)
			),
			"profile" => array(
				"title" => "Profile",
				"icon" => "fa fa-group",
				"url" => APP_URL."/views-profile.php"
			),
			"timeline" => array(
				"title" => "Timeline",
				"icon" => "fa fa-clock-o",
				"url" => APP_URL."/views-timeline.php"
			),
			"search" => array(
				"title" => "Search Page",
				"icon" => "fa fa-search",
				"url" => APP_URL."/views-search.php"
			),
		)
	),
	"ecommerce" => array(
	...
	"misc" => array(
		...
		"sub" => array(
            ...
            "email_template" => array(
				...
				"url" => APP_URL."/misc-email-template.php"
			),			
            "err_404" => array(
				"title" => "Error 404",
