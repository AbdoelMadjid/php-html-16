...
<!-- ==========================CONTENT STARTS HERE ========================== -->
		...
		<header id="header">
			...
			<span id="extr-page-header-space"> <span class="hidden-mobile hiddex-xs">Already registered?</span> <a href="<?php echo APP_URL; ?>/misc-login.php" class="btn btn-danger">Sign In</a> </span>
