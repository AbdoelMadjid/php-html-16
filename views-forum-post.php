			...
			<div class="col-sm-12">
				...
				<div class="well">
					...
					<table class="table table-striped table-forum">
						<thead>
							<tr>
								<th colspan="2"><a href="<?php echo APP_URL; ?>/views-forum.php"> Projects </a> > <a href="<?php echo APP_URL; ?>/views-forum-topic.php">Business Requirement Docs </a> > Nam quam nunc blandit vel </th>
							</tr>
						</thead>
						<tbody>
							<!-- Post -->
							<tr>
								<td class="text-center"><a href="<?php echo APP_URL; ?>/views-profile.php"><img alt="" src="<?php echo ASSETS_URL; ?>/img/flags/us.png"> &nbsp; <strong>John Doe</strong></a></td>
								<td>on <em>Jan 1, 2014 - 12:00am</em></td>
							</tr>
							<tr>
								<td class="text-center" style="width: 12%;">
								<div class="push-bit">
									<a href="<?php echo APP_URL; ?>/views-profile.php"> <img src="<?php echo ASSETS_URL; ?>/img/avatars/sunny.png" width="50" alt="avatar" class="online"> </a>
							...
							<!-- Post -->
							<tr>
								<td class="text-center"><a href="<?php echo APP_URL; ?>/views-profile.php"><img alt="" src="<?php echo ASSETS_URL; ?>/img/flags/es.png"> &nbsp; <strong>Sadi Orlaf</strong></a></td>
								<td>on <em>Jan 1, 2014 - 12:00am</em></td>
							</tr>
							<tr>
								<td class="text-center" style="width: 12%;">
								<div class="push-bit">
									<a href="<?php echo APP_URL; ?>/views-profile.php"> <img src="<?php echo ASSETS_URL; ?>/img/avatars/5.png" width="50" alt="avatar" class="offline"> </a>
								</div><small>473 Posts</small></td>
								<td>
								<p>
							...
							<!-- Post -->
							<tr>
								<td class="text-center"><a href="<?php echo APP_URL; ?>/views-profile.php"><img alt="" src="<?php echo ASSETS_URL; ?>/img/flags/us.png"> &nbsp; <strong>Me</strong></a></td>
								<td><em>Today</em></td>
							</tr>
							<tr>
								<td class="text-center" style="width: 12%;">
